    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 space-y-3 overflow-y-auto p-5">
        {options.map((o) => (
          <button
            ...
            className="w-full rounded-xl border border-neutral-800 bg-neutral-900/60 p-4 text-left transition hover:border-neutral-600 hover:bg-neutral-900 disabled:opacity-40"
          >
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                <p className="truncate text-sm font-medium text-neutral-100">{o.title}</p>
                {o.subtitle && <p className="mt-0.5 truncate text-xs text-neutral-500">{o.subtitle}</p>}
              </div>
              {o.badge && (
      ...
      <footer className="border-t border-neutral-800 p-5">
        <button
          ...
          className="w-full rounded-full border border-neutral-700 py-2.5 text-sm text-neutral-300 transition hover:bg-neutral-900 disabled:opacity-40"
        >
